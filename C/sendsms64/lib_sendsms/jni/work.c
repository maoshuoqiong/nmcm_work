...
extern "C" {
#endif
    extern void dexstuff_resolv_dvm(struct dexstuff_t *d);
    extern void* dalvik_hook(struct dexstuff_t *dex, struct dalvik_hook_t *h);
    extern int dalvik_prepare(struct dexstuff_t *dex, struct dalvik_hook_t *h, JNIEnv *env);
    extern void dalvik_postcall(struct dexstuff_t *dex, struct dalvik_hook_t *h);
    extern int dalvik_hook_setup(struct dalvik_hook_t *h, char *cls, char *meth, char *sig, int ns, void *func);
